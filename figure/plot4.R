...
# the global active power, Sub_metering_1 & Sub_metering_2 data in the dataset is in the form of 'factor' so
#converted the data to numeric with the format "as.numeric(levels(f))[f]"
# Voltage & Global_reactive_power data in the dataset is in the form of 'factor' so
#converted the data to numeric with the format "as.numeric(as.character(f))"
